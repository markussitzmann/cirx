# Generated by Django 4.2.3 on 2023-12-08 22:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='StructureFileCalcInChIStatus',
            fields=[
        ...
        migrations.CreateModel(
            name='StructureFileTag',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tag', models.CharField(max_length=16)),
                ('process', models.CharField(choices=[('addfiles', 'Add Files'), ('register', 'Registation'), ('normalize', 'Normalization'), ('calcinchi', 'InChI Calculation'), ('linkname', 'Name Linking'), ('none', 'None')], default='none', max_length=16)),
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('structure_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='etl.structurefile')),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('structure_file', 'tag', 'process'), name='unique_structure_file_tag_constraint'),
        ),
        migrations.AddConstraint(
            model_name='structurefilerecordrelease',
