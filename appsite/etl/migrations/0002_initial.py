    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process', models.CharField(choices=[('addfiles', 'Add Files'), ('normalize', 'Normalize'), ('calcinchi', 'Calculate InChI'), ('linkname', 'Link Name'), ('none', 'None')], default='none', max_length=16)),
                ('updated', models.DateTimeField(auto_now=True, null=True)),
