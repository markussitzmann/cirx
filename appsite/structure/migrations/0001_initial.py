    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ficts_compound', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ficts_records', to='structure.compound')),
                ('ficus_compound', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ficus_records', to='structure.compound')),
                ...
                ('uuuuu_compound', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='uuuuu_records', to='structure.compound')),
            ],
            options={
                'db_table': 'cir_record',
            },
        ...
        migrations.AddField(
            model_name='compound',
            name='structure',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='structure.structure2'),
        ),
        migrations.CreateModel(
            name='Association',
            fields=[
