    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('save_opt', models.CharField(blank=True, default=None, max_length=2, null=True)),
                ('added', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='structureinchiassociation',
            name='inchitype',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='structureinchiassociations', to='resolver.inchitype'),
        ),
        migrations.AddField(
            model_name='structureinchiassociation',
            name='structure',
        ...
        migrations.AddField(
            model_name='structure',
            name='names',
            field=models.ManyToManyField(related_name='structures', through='resolver.StructureNames', to='resolver.name'),
        ),
        migrations.AddField(
            model_name='structure',
            name='uuuuu_parent',
        ...
        migrations.AddField(
            model_name='release',
            name='database',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resolver.database'),
        ),
        migrations.AddField(
            model_name='release',
            name='publisher',
        ...
        migrations.AddField(
            model_name='record',
            name='database',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='resolver.database'),
        ),
        migrations.AddField(
            model_name='record',
            name='regid',
