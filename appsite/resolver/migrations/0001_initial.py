...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('affinity_class', models.CharField(choices=[('exact', 'Exact'), ('narrow', 'Narrow'), ('broad', 'Broad'), ('unknown', 'Unknown'), ('unspecified', 'Unspecified'), ('generic', 'Generic'), ('related', 'Related')], default='unspecified', max_length=16)),
