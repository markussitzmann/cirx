...
-- **** insert PubChem SIDS into cir_record_names table
...
-- **** insert PubChem SIDS into cir_record_names table !!! Check if Publisher 4 is Pubchem, this is used for preliminary set uo
