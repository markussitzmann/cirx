...
--     (SELECT name_id, count(*) as c FROM tmp_cir_structure_name_associations where name_type_id=5 group by name_id) as i
-- ) as o
-- WHERE o.name_id = m.name_id and name_type_id=5;
--
-- UPDATE tmp_cir_structure_name_associations as m SET confidence = o.confidence FROM
-- (SELECT i.name_id, ceil(100/i.c) as confidence FROM
--     (SELECT name_id, count(*) as c FROM tmp_cir_structure_name_associations where name_type_id=3 group by name_id) as i
-- ) as o
-- WHERE o.name_id = m.name_id and name_type_id=3;

-- CREATE TABLE IF NOT EXISTS tmp_best_cir_structure_name_associations AS
-- SELECT a.* FROM tmp_cir_structure_name_associations a
...
-- UPDATE tmp_cir_structure_name_associations set confidence=1 where confidence=0;
--
-- UPDATE cir_structure_name_associations t
-- SET confidence = s.confidence
-- FROM
-- (select id, confidence from tmp_cir_structure_name_associations order by id LIMIT 10000000 OFFSET 0) as s
-- WHERE t.id = s.id;
--
-- UPDATE cir_structure_name_associations t
-- SET confidence = s.confidence
-- FROM
-- (select id, confidence from tmp_cir_structure_name_associations order by id LIMIT 10000000 OFFSET 10000000) as s
-- WHERE t.id = s.id;
--
-- UPDATE cir_structure_name_associations t
-- SET confidence = s.confidence
-- FROM
-- (select id, confidence from tmp_cir_structure_name_associations order by id LIMIT 10000000 OFFSET 20000000) as s
-- WHERE t.id = s.id;
--
-- UPDATE cir_structure_name_associations t
-- SET confidence = s.confidence
-- FROM
-- (select id, confidence from tmp_cir_structure_name_associations order by id LIMIT 10000000 OFFSET 30000000) as s
-- WHERE t.id = s.id;
--
-- UPDATE cir_structure_name_associations t
-- SET confidence = s.confidence
-- FROM
-- (select id, confidence from tmp_cir_structure_name_associations order by id LIMIT 10000000 OFFSET 40000000) as s
-- WHERE t.id = s.id;
--
-- UPDATE cir_structure_name_associations t
-- SET confidence = s.confidence
